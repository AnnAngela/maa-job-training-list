...
const safeAdd = (x, y) => (x + y) & 0xffffffff;

const leftRotate = (value, count) => (value << count) | (value >>> (32 - count));

const md5cmn = (q, a, b, x, s, t) => safeAdd(leftRotate(safeAdd(safeAdd(a, q), safeAdd(x, t)), s), b);
